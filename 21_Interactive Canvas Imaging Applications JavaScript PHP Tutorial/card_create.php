...
<head>
    ...
    <style>
        ...
        #theform{ background: url(images/demo_card_1.jpg) no-repeat; width:800px; height:500px; margin:0px auto; }
        #theform > div{ margin-left:240px; padding-top:80px;}
        #theform > div > input{ display:block; padding:7px; width:320px; }
        #theform > div > #name2{ margin-top:290px; }
        .menu{ width:600px; margin:0px auto; text-align:center; padding:20px; }
    ...
    <script>
        ...
        demo_card_1.src = "images/demo_card_1.jpg";
        function preview(){
